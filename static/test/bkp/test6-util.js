...
function fetch_id_title_rev_data() {
    ...
    url = "http://192.168.43.49:5000/static/recom/movie_id_int_rev.json";
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.open( "GET", url = url, false ); 
    xmlHttp.send( null );
    return xmlHttp.responseText;
...
function fetch_cluster_ids(cluster) {
    ...
    url = "http://192.168.43.49:5000/static/recom/cluster_members_" + cluster + ".json";
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.open( "GET", url = url, false ); 
    xmlHttp.send( null );
    return xmlHttp.responseText;
...
function recommend() {
    recom = paged_results(0, 10, picks);
    out = ""
